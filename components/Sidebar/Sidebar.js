    ...
    return (
        <div className='h-screen w-full overflow-y-scroll font-nunito_sans bg-white dark:bg-primary'>
            ...
            <div className="menu-items ">
                <div className="w-full h-[60px] pl-5">
                    <div onClick={toggleSidebar} className="flex cursor-pointer flex-row items-center h-full justify-start">
                ...
                <div className="w-full h-[60px] pl-5">
                    <div className="flex flex-row items-center h-full justify-start">
                        <Link href="/developers/registration">
                ...
                {openSub1 && (
                    <div className='bg-fields bg-opacity-10 pl-5'>
                        ...
                        <div className="w-full h-[60px]">
                            <div onClick={() => setOpenSub2(!openSub2)} className={`flex flex-row cursor-pointer items-center h-full justify-start `}>
